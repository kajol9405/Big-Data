...
def main():
  ...
  #give required file names for accuracies
    traindata = read_data_set('trainData3.arff')

    testdata = read_data_set('testData3.arff')
	
    print 'Got training and test data.'
    train(traindata[0], testdata[0], traindata[2])
